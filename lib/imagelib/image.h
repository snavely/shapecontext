...
img_t *img_read_bmp_file(const char *fname);
void img_write_bmp_file(img_t *img, const char *fname);
void img_write_bmp_file_gray(img_t *img, const char *fname, int blue);
